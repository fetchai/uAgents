...
async def fetch_data_from_rapidapi(name, email, phone, address, skills, certifications,awards, experiences):
    try:
...
async def handle_message(ctx: Context, sender: str, msg: Request):
    response = await fetch_data_from_rapidapi(msg.name, msg.email, msg.phone, msg.address, msg.skills, msg.certifications,msg.awards, msg.experiences)
    await ctx.send(
