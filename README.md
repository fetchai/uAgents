...
- 📊 **Observable**: Agents registered on Agentverse automatically report start/stop, message, and error telemetry events to the Agentverse dashboard (toggle with `report_events`).
