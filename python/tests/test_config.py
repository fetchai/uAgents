...
agents = [
    Agent(),
    Agent(mailbox="mailbox_key@some_url"),
    Agent(mailbox={"mailbox_key": "mailbox_key", "base_url": "some_url"}),
    Agent(mailbox="mailbox_key"),
    Agent(agentverse="mailbox_key@some_url"),
    Agent(agentverse="mailbox_key"),
    Agent(agentverse="http://some_url"),
    Agent(agentverse="wss://some_url"),
    Agent(agentverse="ws://some_url"),
    Agent(agentverse={"mailbox_key": "mailbox_key", "protocol": "wss"}),
