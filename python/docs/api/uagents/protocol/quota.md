...
```python
from uagents.protocol.quota import AccessControlList, QuotaProtocol, RateLimit
...
## QuotaProtocol Objects[↗](https://github.com/fetchai/uAgents/blob/main/python/src/uagents/protocol/quota.py#L106)
...
#### __init__[↗](https://github.com/fetchai/uAgents/blob/main/python/src/uagents/protocol/quota.py#L107)
```python
...
#### on_message[↗](https://github.com/fetchai/uAgents/blob/main/python/src/uagents/protocol/quota.py#L134)
```python
def on_message(
        model: type[Model],
...
#### wrap[↗](https://github.com/fetchai/uAgents/blob/main/python/src/uagents/protocol/quota.py#L164)
```python
...
#### add_request[↗](https://github.com/fetchai/uAgents/blob/main/python/src/uagents/protocol/quota.py#L232)
```python
